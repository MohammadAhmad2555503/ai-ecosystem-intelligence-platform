#!/usr/bin/env python3
"""
Checks for the Step 8 Airflow DAG.

This file does not import Airflow. It only checks that the DAG file exists
and contains the expected pipeline structure.
"""
